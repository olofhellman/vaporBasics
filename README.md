This repo is a step-by-step tour of building a very simple web service backend using the Vapor framework

The starting point is essentially the output of the vapor new command -- a vapor project ready to customize.
